"""viaductcars_22448 URL Configuration
...
admin.site.site_header = "ViaductCars"
admin.site.site_title = "ViaductCars Admin Portal"
admin.site.index_title = "ViaductCars Admin"

# swagger
api_info = openapi.Info(
    title="ViaductCars API",
    default_version="v1",
    description="API documentation for ViaductCars App",
)
